                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body text-left">
                            ...
                            <div className="text-muted text-right">
                                Check the <a href="https://github.com/cyriellecoppe/cosmeticlabeldecoder_ui" target="_blank" rel="noopener noreferrer">source code</a> on GitHub. <i className="fa fa-github" aria-hidden="true"></i>
                            </div>
                        </div>
